...
class Persistencia{
	...
	function GuardarTickets($Tickets){
		$Dist1 = new Dist1();
		$row = $Dist1->EjecutarSQl("INSERT INTO tickets (DirDestino,rifempresa,datee,producto,precio)
		VALUES(
		'".$Tickets->DirDestino."',
		'".$Tickets->rifempresa."',
		'".$Tickets->datee."',
	...
	function GuardarFactura($Factura){
		$Dist1 = new Dist1();
		$row = $Dist1->EjecutarSQl("INSERT INTO factura (userid,montocancelar,descripcion,femision,status,fvencimiento,userrif)
		VALUES(
		'".$Factura->userid."',
